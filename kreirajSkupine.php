...
$sqlselectmoderator = "select vrtic_id from vrtic where korisnik_korisnik_id='{$idmoderatora}'";
$rezsqlmoderator = $dbVeza->selectDB($sqlselectmoderator);
$row2 = mysqli_fetch_assoc($rezsqlmoderator);
    ...
    <body id="sidebar_push" class="resetka" name="vrtici" onload="DobijVrticeAdmin()">
        ...
        <div class="popis_vrtica" style= "transform: translate(10%, -25%);">
            <table id="popis_table7">
                <thead>
                    <tr>
                        <th>ID skupine kojoj ste moderator</th>
                        <th>Naziv skupine</th>
                ...
                <tbody id="tablica_skupine" for="popis_vrtica">
                    ...
                    $dbVeza = new Baza();
                    $dbVeza->spojiDB();
                    $sqlSkupineMod = "SELECT * FROM skupina left join vrtic on skupina.vrtic_vrtic_id=vrtic.vrtic_id where vrtic.korisnik_korisnik_id='{$idmoderatora}'";
        ...
        <div class="login_form">
            <form method="post" action="" id="forma_vrtic" >
                ...
                <div class="container">
                    ...
                    <label for="vrticcbox"><b>Vrtic(možete samo vrtić kojemu ste moderator)</b></label><br>
