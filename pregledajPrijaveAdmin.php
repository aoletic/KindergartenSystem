...
if (isset($_POST['upisi_dijete'])) {
    ...
    if ($row3['prihvacen'] == 'da') {
        $sqlUpisiDijete = "insert into dijete(dijete_id, ime_djeteta, prezime_djeteta, godina_rodenja, "
                ...
                . "'https://barka.foi.hr/WebDiP/2019_projekti/WebDiP2019x091/multimedija/', '{$suglasnost}', '{$id_prijave}', '{$VrticID}')";
...
<?php include './forma_search_odjava.php'; ?>
        ...
        <div class="naslov">
            ...
            <table id="popis_table10">
                ...
                <tbody id="tablica_dolascibody" for="popis_vrtica">
                    ...
                    $sqlDolasciMod = "SELECT prijave.prijave_id, skupina.naziv_skupine, prijave.prihvacen, prijave.upisan from prijave "
                            . "left join upisi on prijave.upisi_upisi_id=upisi.upisi_id left join skupina on "
                            . "upisi.skupina_skupina_id=skupina.skupina_id";
        ...
        <div class="login_form" style= "transform: translate(5%, 25%);">
            <form method="post" action="" id="forma_vrtic" enctype="multipart/form-data">
                ...
                <div class="container">
                    <label for="id_prijave"><b>ID prijave</b></label><br>
